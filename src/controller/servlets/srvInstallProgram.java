 ...
 * @author rdinarte
 */
public class srvInstallProgram extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String executable = mrequest.getParameter("txtExecutable");
        String repositoryText = mrequest.getParameter("radSource");
        ...
        if(fromRepository)
        {
            ...
            String repositoryUrl = mrequest.getParameter("txtUrl");
            result = agent.InstallProgram(request, description, executable, folder,
                    repositoryType, repositoryUrl);
        }
        else
        {
            String inputFile = mrequest.getParameter("dlgLocalFile");
            byte[] fileContent = mrequest.getFile("dlgLocalFile");
            result = agent.InstallProgram(request, description, executable, folder, inputFile,
                    fileContent);
        }
