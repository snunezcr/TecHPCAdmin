...
#Let's backup de DB
/opt/PostgreSQL/9.0/bin/pg_dump --host localhost --port 5432 --username "postgres" --format plain --create --verbose --file "$targetCodeFolder/db/HPCA.sql" "HPCA"
